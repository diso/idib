...
class OpenIDRequestHandler(BaseHTTPRequestHandler):
    ...
    def doXRDS(self):
        ...
        <xrds xmlns="xri://$xrds">
            <xrd version="2.0" xmlns:simple="http://xrds-simple.net/core/1.0" xmlns="xri://$XRD*($v*2.0)">
            <type>xri://$xrds*simple</type>
            <Service>
              <TYPE>http://specs.openid.net/login/1.0/</TYPE>
              <uri simple:httpMethod="GET">http://localhost:8001/verify</uri>
            </Service>

            <service>
              <type>http://specs.openid.net/auth/2.0/return_to</type>
              <uri>http://jyte.com/auth/openid_response</uri>
              <uri>http://jyte.com/auth/immediate_response</uri>
            </service>
          </xrd>
        </xrds>"""
        self.wfile.write(xrds)
    ...
    def autoSubmit(self, form, id):
        ...
        response = """\
<html><head><title>OpenID transaction in progress</title>
</head>
...
"""%(id, form)
    ...
    def render(self, message=None, css_class='alert', form_contents=None,
        ...
        self.send_header('x-xrds-location','http://localhost:8001/xrds')
